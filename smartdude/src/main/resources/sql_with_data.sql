...
INSERT INTO `locationdetail` VALUES (5,'TN','CHENNAI','SIRUSERI','CTS','CAFE','1','A',13,NULL,NULL);
...
CREATE TABLE `locationqmanagerassociation` (
  ...
  CONSTRAINT `ven` FOREIGN KEY (`vendorid`) REFERENCES `vendor` (`vendorid`)
...
INSERT INTO `queuemanager` VALUES (4,'ramesh','12345678','123@m.com','ra12QM',13,'2019-04-25 22:28:11','2019-04-25 22:28:11',0),(5,'suresh','12345678','123@m.com','su12QM',13,'2019-04-25 22:33:04','2019-04-25 22:33:04',1);
...
INSERT INTO `role` VALUES (58,'ADMIN',36),(59,'VENDOR',36),(60,'QM',36),(67,'VENDOR',40),(68,'QM',40),(69,'VENDOR',41),(70,'QM',41),(73,'VENDOR',43),(74,'QM',43);
...
INSERT INTO `user` VALUES (36,'abc','$2a$10$LQeBNQqzLZmrYBCxCLnaMuElBhin2yoQtOzwOvZQ0uV4.7cUZLEQe','ISS',NULL,NULL),(40,'Umashankar','$2a$10$VvdqWTGn8MaoChKCRo3UZumu0OLC0ujd2TIdiDNhTLitXlUWWVfy.','ISS',11,NULL),(41,'abcd','$2a$10$6xjIx6Z8YgrLOlvdBdW9c.VJ9D2FqiV4Leo79JKtQC57o.l0pHSNW','ISS',NULL,NULL),(43,'pavithra','$2a$10$fQkQYgvhzQGXXetCgIhIcub9iHKnc4FojTDA.eTt/QDSZVA3A70ZO','AGS',13,NULL);
...
INSERT INTO `vendor` VALUES (11,'ISS','Umashankar','Cafeteria','ISS Food Chain','2019-04-24 08:19:12',1,'mISS698','9698708672','2019-04-24 09:03:56',NULL),(12,'AGS','pavithra','Entertainment','AGS Cini','2019-04-24 22:42:13',1,'paAGS9698','9698708672','2019-04-24 22:45:46',NULL),(13,'AGS','pavithra','Entertainment','AGS Cini','2019-04-25 07:28:11',1,'paAGS9698','9698708672','2019-04-25 07:28:31',NULL);
...
-- Dump completed on 2019-04-26  9:13:51
