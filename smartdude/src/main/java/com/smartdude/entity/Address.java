 ...
 * 
 * @PersistenceConstructor public Address(long addressId, String address, String
 * city, String state, long zipcode) { super(); this.addressId = addressId;
 * this.address = address; this.city = city; this.state = state; this.zipcode =
 * zipcode; }
 * 
 * 
 * 
